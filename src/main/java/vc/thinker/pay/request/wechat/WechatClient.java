...
import vc.thinker.pay.request.utils.WebUtils;
import vc.thinker.pay.request.utils.XmlUtil;
...
public class WechatClient {
    ...
    public WechatUnifiedOrder.Response unifiedOrder(WechatUnifiedOrder unifiedOrder) {
        ...
        System.err.println(unifiedOrder.getSign());
    ...
    public WechatRefund.Response refund(WechatRefund wechatRefund) {
        ...
        try {
            InputStreamEntity inputStreamEntity = new InputStreamEntity(
                    new ByteArrayInputStream(requestXml.getBytes("UTF-8")), ContentType.APPLICATION_XML);
            String resultXml = WebUtils.post(WechatConfig.CERT_PATH, mch_id, WechatConfig.REFUND_URL, inputStreamEntity);
    ...
    public WechatOrderQuery.Response orderQuery(String orderNo) {
        ...
        return WechatConfig.getWechatClientInstance().orderQuery(orderQuery);
    }
