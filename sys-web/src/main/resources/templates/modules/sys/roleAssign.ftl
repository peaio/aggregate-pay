...
<body>
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		<thead><tr><th>归属公司</th><th>归属部门</th><th>登录名</th><@shiro.hasPermission name="sys:user:edit"><th>操作</th></@shiro.hasPermission></tr></thead>
		<tbody>
		<#list  users as user>
			<tr>
				...
				<@shiro.hasPermission name="sys:role:edit"><td>
					<a href="${ctx}/sys/role/outrole?userId=${user.id}&roleId=${role.id}" 
						onclick="return confirmx('确认要将用户<b>[${user.loginName!}]</b>从<b>[${role.name!}]</b>角色中移除吗？', this.href)">移除</a>
