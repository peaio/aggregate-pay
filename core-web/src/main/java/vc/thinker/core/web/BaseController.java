...
import vc.thinker.core.beanvalidator.BeanValidators;
...
public abstract class BaseController {
	 ...
	 * @param messages 消息
	 */
	protected void addMessageCode(Model model,HttpServletRequest request,String code) {
	 ...
	 * @param messages 消息
	 */
	protected void addMessageCode(Model model,HttpServletRequest request,String code,String ... param) {
		RequestContext context=new RequestContext(request);
	 ...
	 * @param messages 消息
	 */
	protected void addMessageCode(RedirectAttributes model,HttpServletRequest request,String code,String ... param) {
		RequestContext context=new RequestContext(request);
		addMessage(model, context.getMessage(code,param));
	}
	/**
